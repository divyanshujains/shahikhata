      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={() => setnewproductpopup(true)} className="bg-blue-500 hover:bg-green-600 text-white px-6 py-2 rounded-md text-sm transition-colors flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {data.map((product,  id) => (
              <div key={id} className="bg-gray-50 rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="mt-4 flex justify-end">
                  <button onClick={()=> updateproduct(product.id)} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm transition-colors">
                    Edit Product
                  </button>
                </div>
              </div>
  ...
  {popup && (
        <div className="fixed inset-0 opac-50 flex items-center justify-center z-50">
          <div className="bg-gradient-to-br from-white to-gray-50 p-8 rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] w-96 transform transition-all hover:scale-[1.02]">
            <h3 className="text-3xl font-bold mb-6 text-gray-800 text-center bg-clip-text  bg-gradient-to-r from-blue-600 to-purple-600">Edit Product</h3>
            <input 
              type="text" 
              value={editname}
